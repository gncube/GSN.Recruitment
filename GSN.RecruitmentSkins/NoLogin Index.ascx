...
<div id="siteWrapper" class="devolved">
    ...
    <div id="contentWrapper">
        <div class="container">
            <div class="row">
                <div id="LeftBannerPane" class="col-md-4" runat="server"></div>
                <div id="MiddleBannerPane" class="col-md-4" runat="server"></div>
                <div id="RightBannerPane" class="col-md-4" runat="server"></div>
            </div>
