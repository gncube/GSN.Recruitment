        ...
        <div class="container">
            <div class="row margin-bottom-20">
                <div id="Breadcrumb" class="col-md-12">
                    ...
                    <dnn:BREADCRUMB ID="dnnBreadcrumb" runat="server" CssClass="breadcrumbLink" RootLevel="0" Separator="&lt;img src=&quot;/Portals/_default/Skins/GND.Intranet2/assets/img/breadcrumb.png&quot;&gt;" />
                </div>
            </div>
            <div class="row">
