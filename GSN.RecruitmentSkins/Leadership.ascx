...
<dnn:DnnCssInclude ID="loginCSS" runat="server" FilePath="assets/css/login/leadership.css" PathNameAlias="SkinPath" />
<dnn:DnnCssInclude ID="searchCSS" runat="server" FilePath="assets/css/search/leadership.css" PathNameAlias="SkinPath" />
...
<dnn:DnnCssInclude ID="menuCSS" runat="server" FilePath="assets/css/headers/leadership.css" PathNameAlias="SkinPath" />
...
<div id="siteWrapperLeadership">

    <div class="row silver margin-bottom-20">
        <div class="container">
            <%--<div id="login">
            ...
            <!-- Social Section -->
            <!--#include file="assets/social.ascx"-->
            <!-- End Social Section -->
        </div>
    </div>
    ...
    <div class="container">
        <div class="pull-left">
            <a class="Slogan" href="<%=NavigateURL(PortalSettings.HomeTabId)%>" title="<%=PortalSettings.PortalName %>">
                <img src="<%= SkinPath %>assets/img/leadership-logo.gif" title="HEEM Leadership" />
            </a>
        </div>
        <div class="pull-right">
    ...
    <div id="siteHeadouterLeadership">
        <div class="navbar navbar-default">
            <div id="siteHeadinner" class="container">
                ...
                <div class="pull-right call-action">
                    <a href="http://workforce.em.hee.nhs.uk/HowToApply.aspx" class="btn btn-lg btn-action" title="Information on how to apply">How To Apply</a>
                </div>
    ...
    <div class="" id="FullPane" runat="server"></div>
    <!--/siteHeadouter-->
    <div id="contentWrapperLeadership">
        <div class="container">
            <%--<div class="row margin-bottom-20">
                <div id="Breadcrumb" class="col-md-12">
                    <a href="<%=NavigateURL(PortalSettings.HomeTabId)%>" title="Go to homepage"><i class="fa fa-home "></i></a>
                    <img src="<%= SkinPath %>assets/img/breadcrumb.png" />
...
<div id="footerWrapper">
    <div class="row">
        <div class="container">
            <div class="col-xs-12 pull-left margin-bottom-20">
                <img src="<%= SkinPath %>assets/img/faculty.gif" title="HEEM Leadership" />
            </div>
        </div>
    </div>
